    ...
    def auth(self):
        with self.browser as browser:
            ...
            login_input = browser.find_element(By.CSS_SELECTOR,
                                               "input[class='tiktok-11to27l-InputContainer etcs7ny1']")
            login_input.clear()
            login_input.send_keys(username)
            time.sleep(2)
            # enter password
            password_input = browser.find_element(By.CSS_SELECTOR,
                                                  "input[class='tiktok-wv3bkt-InputContainer etcs7ny1']")
            password_input.clear()
            password_input.send_keys(password)
            time.sleep(3)
            # press login btn
            browser.find_element(By.CSS_SELECTOR,
                                 "button[class='e1w6iovg0 tiktok-11sviba-Button-StyledButton ehk74z00']").click()
            time.sleep(30)
    ...
    def load_video(self):
        with self.browser as browser:
            ...
            for cookie in pickle.load(
                    open(f'C:/Users/zubri/PycharmProjects/autoposting/cookies/{username}_cookies', 'rb')):
            ...
            app.Dialog.Edit0.type_keys(
                r"C:\Users\zubri\PycharmProjects\autoposting\video\Код фильма 999 #фльмы #приколы.mp4",
                with_spaces=True)
            ...
            sound_volume = browser.find_elements(By.CSS_SELECTOR, "input[class='jsx-2730543169 scaleInput']")[-1]
